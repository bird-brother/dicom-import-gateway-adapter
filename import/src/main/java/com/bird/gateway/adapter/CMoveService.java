...
import com.bird.gateway.adapter.cmove.ISender;
import com.bird.gateway.adapter.cmove.ISenderFactory;
            ...
            try {
                ...
                try {
                    ...
                    if (qidoResult == null || qidoResult.length() == 0) {
                        throw new DicomGatewayException("No instances to move",
                ...
                for (Object instance : qidoResult) {
                    ...
                    } catch (DicomGatewayException | IOException e) {
